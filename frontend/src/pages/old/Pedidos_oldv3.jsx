            ...
            >
              <thead>
                <tr style={{ background: "#f8fafc" }}>
                  ...
                  <th style={{ ...thStyle(), width: "8%" }}>Fecha</th>
                  <th style={{ ...thStyle(), width: "11%" }}>Solicitante</th>
                  <th style={{ ...thStyle(), width: "25%" }}>Detalle</th>
                  <th style={{ ...thStyle(), width: "8%" }}>Tamaño</th>
                  <th style={{ ...thStyle(), width: "8%" }}>Cantidad</th>
                  <th style={{ ...thStyle(), width: "17%" }}>Destino</th>
                  <th style={{ ...thStyle(), width: "8%" }}>Estado</th>
                  <th style={{ ...thStyle(), width: "10%" }}>Acciones</th>
                </tr>
              </thead>
